<g:render template="../templates/createRace"></g:render>
<g:form id="myform" controller="Race" action="createRace">

	<label> Race Name:</label>
	<input type="text" name="name" placeholder="Enter the first Name" />
	<br>
	...
	<g:submitButton name="submit" value="Create Race"
		onclick="return validateAndPost()" />
</g:form>
