...
<body>
	...
	<div id="tabs">
		<ul>
			...
			<li><a href="#profileDetail">profileDetail</a></li>
			<li><a href="#profileEdit">profileEdit</a></li>
		</ul>
		<div id="tabs-1">
		...
		<div id="profileDetail">
			...
			<button onclick="callEditRunner()" class="btn btn-success">
		...
		<div id="profileEdit" class="profileEdit ">
			...
			<g:render template="../allViews/templates/editRunner"></g:render>
		</div>
		<div id="profileUpdated" class="profileUpdated"></div>
	</div>
	<button onclick="callJSONaction()"></button>
</body>
</html>
